...
class CreateInvoice2DetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('invoice2_details', function (Blueprint $table) {
            $table->id();
            $table->foreignId('invoice_id')->nullable();
            $table->foreignId('product_id')->nullable();
            $table->foreignId('po_id')->references('id')->on('purchase_details');
            $table->decimal('po_rate')->nullable();
    ...
    {
        Schema::dropIfExists('invoice2_details');
    }
}
