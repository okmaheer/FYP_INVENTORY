...
function calculate_store(sl) {
    ...
    var beam_issue = $("#beam_issue_" + sl).val();
    var beam_qty = $("#beam_qty_" + sl).val();

    var ttl_length = beam_issue * beam_qty;
    $("#total_length_" + sl).val(ttl_length.toFixed(2));


    // var ttl_length = $("#total_length_" + sl).val();
    //receive warp set*set_qty
    //     var set= $("#set_" + sl).val();
    //     var set_qty = $("#set_qty_" + sl).val();
    //    console.log(set);
    //     var total_length_meter = set* set_qty;
    //     $("#total_length_meter_" + sl).val(total_length_meter.toFixed(2));
...
function product_pur_or_list(sl) {
    ...
    var options = {
        ...
        select: function(event, ui) {
            ...
            var ajax2url = '/dashboard/textile/retrieveReceiveWarpData';
