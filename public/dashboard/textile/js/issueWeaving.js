...
function calculate_store(sl) {
    ...
    var ttl_length = 0;
    var set = $("#set_issue_" + sl).val();
    var per_set_qty = $("#per_set_qty_" + sl).val();
     console.log(set);
    console.log(per_set_qty);

    ttl_length = set * per_set_qty;
...
function product_pur_or_list(sl) {
    ...
    var options = {
        ...
        select: function(event, ui) {
            ...
            var available_quantity = 'receive_warp_stock_' + sr_no;
            // alert(available_quantity);
            var form2Data = {
                product_id: ui.item.value,
                supplier_id: supplier_id
            };
            var ajax2url = '/dashboard/textile/retrieve_issue_weaving_data';
            ...
            $.ajax({
                ...
                success: function(data) {
                    console.log(data);
                    $('#' + available_quantity).val(data.warp_amount);
