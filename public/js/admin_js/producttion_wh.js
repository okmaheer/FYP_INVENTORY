...
function full_paid() {
    ...
    var options = {
        ...
        $.ajax( {
          url: base_url + "purchase/purchase/bdtask_product_search_by_receipe",
          method: 'post',
          dataType: "json",
          data: {
            term: request.term,
