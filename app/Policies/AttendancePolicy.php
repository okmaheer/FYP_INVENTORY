...
class AttendancePolicy
{
    ...
    {
        //
        return $user->ability('edit_attendance');
    }
    ...
    public function syncAttendance(User $user) {
        return $user->ability('sync_attendance_from_machine');
    }

    public function report(User $user) {
        return $user->ability('attendance_report');
    }
}
