...
var options = {
    ...
    colors: ["#95a6bf"],
    xaxis: {
        categories: ['Coke', 'Cement', 'Thermal', 'Yarn', 'Rice', 'Plates', 'Deal 1', 'Night Deal 3', 'Kinat Chawal'],
    },
    states: {
        hover: {
            filter: 'none'
...
var options = {
  ...
  colors: ["#a3cae0", "#232f5b","#f06a6c", "#f1e299"],
  legend: {
      show: true,
      position: 'bottom',
...
chart.render();
  ...
  var options = {
    ...
    series: [44, 55, 17, 15],
    colors: ["#a3cae0", "#232f5b", "#f1e299", "#08aeb0"],
    labels: ["Comedy", "Action", "Drama", "Horror"],
    dataLabels: {
        dropShadow: {
            blur: 3,
            opacity: 0.8
