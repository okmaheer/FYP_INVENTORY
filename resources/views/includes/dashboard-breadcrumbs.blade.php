<div class="page-wrapper-img">
    <div class="page-wrapper-img-inner">
        <div class="sidebar-user media">
            <img src="{{ asset(\Cache::get(\CacheEnum::AUTH_LOCATION)->logo) }}" alt="user" class="img-thumbnail mb-1"
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            <a href="javascript:void(0);" class="btn btn-xs btn-danger text-white w-md float-right ">Customer Receive</a>
                            <a href="{{ route('supplier.payment') }}" class="btn btn-xs btn-primary text-white w-md float-right mr-1">Supplier Payment</a>
                            <a href="{{ route('dashboard.accounts.purchase.create') }}" class="btn btn-xs btn-info text-white w-md float-right mr-1">Purchase</a>
                            <a href="{{ route('dashboard.marquee.booking.create') }}" class=" btn btn-xs btn-warning text-white w-md float-right mr-1">Create Booking</a>
                            <a href="{{ route('dashboard.marquee.quotation.booking.create') }}" class=" btn btn-xs btn-success text-white w-md float-right mr-1">Create Quotation</a>
                            <a href="javascript:void(0);" class=" btn btn-xs btn-secondary w-md float-right mr-1" data-toggle="modal" data-target="#calendar-modal">Event Calendar</a>
                        </div>
                    </div>
                </div>
                <!--end page title box-->
