<div class="row" style="padding-bottom: 10px; display: flex !important;">
    <div style="width: 25%;align-self: center!important;">
        <img src="{{ asset(\Cache::get(\CacheEnum::AUTH_LOCATION)->logo) }}" alt="logo-small" width="128px">
    </div>
    ...
    <div style="width: 20%;align-self: center!important;">
        <div class="pl-3" style=" border-left: 1px solid #a8a8b1;">
            ...
            <p class="text-muted mb-0">{!! \Cache::get(\CacheEnum::AUTH_LOCATION)->website ?? '&nbsp;' !!}</p>
            <p class="text-muted mb-0">{!! \Cache::get(\CacheEnum::AUTH_LOCATION)->email ?? '&nbsp;' !!}</p>
        </div>
    </div>
    <div style="width: 20%;align-self: center!important;">
        <div class="pl-3" style=" border-left: 1px solid #a8a8b1;">
            <i class="mdi mdi-phone" style="font-size: 24px;color: #a8a8b1;"></i>
            <p class="text-muted mb-0">{{ \Cache::get(\CacheEnum::AUTH_LOCATION)->mobile_1 }}</p>
            <p class="text-muted mb-0">{!! \Cache::get(\CacheEnum::AUTH_LOCATION)->phone_1 ?? '&nbsp;' !!}</p>
        </div>
    </div>
    <div style="width: 20%;align-self: center!important;">
        <div class="pl-3" style=" border-left: 1px solid #a8a8b1;">
            <i class="mdi mdi-map-marker" style="font-size: 24px;color: #a8a8b1;"></i>
            <p class="text-muted mb-0">{!! \Cache::get(\CacheEnum::AUTH_LOCATION)->address_1 !!}<br>{!! \Cache::get(\CacheEnum::AUTH_LOCATION)->address_2 ?? '&nbsp;' !!}</p>
        </div>
    </div>
</div>
