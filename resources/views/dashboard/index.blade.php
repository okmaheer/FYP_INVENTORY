    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card text-white bg-gradient7 ">
                        <div class="card-body">
                            <blockquote class="card-bodyquote mb-0">
                                        ...
                                        <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                                            <div class="text-center">
                                                ...
                                                <div class="mt-2 align-item-center">
                                                    <a href="{{route('invoice.id.search',$event->id)}}" class="btn btn-sm btn-primary text-light mb-2"><i class="fas fa-receipt mr-1"></i>View Invoice</a>
                                                </div>
                                            </div>
                                        </div>
                                    @empty
