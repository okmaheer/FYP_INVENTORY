                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Add New Bank</h4>
                                                ...
                                                <div class="general-label mt-4">
                                                    {!! Form::open(['route' => 'dashboard.accounts.bank.store', 'files' => true, 'class' => 'solid-validation'] ) !!}
                                                    {!! csrf_field() !!}
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                {!!  Form::text('name',null,['id'=>'bank_name','class'=>'form-control ','placeholder'=>'Bank Name', 'required']) !!}
                                                    ...
                                                    @include('dashboard.accounts.common.buttons.buttons-crud', ['save' => true, 'reset' => true, 'cancel' => true, 'cancel_route' => 'dashboard.accounts.bank.index'])
                                                    {!! Form::close() !!}
                                                </div>
