                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="general-label">
                                    {!! Form::model($voucherInfo,['route' => ['dashboard.accounts.contra.voucher.update',$voucherInfo[0]->VNo], 'files' => true, 'class' => 'solid-validation'] ) !!}
                                    {!! csrf_field() !!}
                                    @method('PATCH')

                                    @include('dashboard.accounts.account.vouchers.common.contra-common',['for'=>'edit'])
