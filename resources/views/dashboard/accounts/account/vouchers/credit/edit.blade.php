                ...
                <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="penal-title  border-grey border-bottom">
                                <h4 class="p-3 text-success">Credit Voucher</h4>
                                @include('includes.messages')
                            </div>
                            <div class="card-body">

                                <div class="general-label">
                                    {!! Form::model($debitInfo,['route' => ['dashboard.accounts.credit.voucher.update',$debitInfo[0]->VNo], 'files' => true, 'class' => 'solid-validation'] ) !!}
                                    {!! csrf_field() !!}
                                    @method('PATCH')

                                    @include('dashboard.accounts.account.vouchers.common.credit-common',['for'=>'edit'])
