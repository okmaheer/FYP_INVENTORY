                ...
                <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="penal-title  border-grey border-bottom">
                                <h4 class="p-3 text-dark">Credit Voucher</h4>
                            </div>
                            <div class="card-body">

                                <div class="general-label">
                                    {!! Form::open(['route' => 'dashboard.accounts.credit.voucher.store', 'files' => true, 'id'=>'voucher_form', 'class' => 'solid-validation'] ) !!}
                                    {!! csrf_field() !!}

                                    @include('dashboard.accounts.account.vouchers.common.credit-common')
