@if(isset($for))
    @if(count($debitInfo))
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                {!!  Form::text('voucher_no',$debitInfo[0]->VNo,['id'=>'voucher_no','class'=>'form-control ','placeholder'=>'"DV-2','readonly','tabindex'=>'-1']) !!}
        ...
        <div class="form-group row">
            <div class="col-sm-3">
                {!!  Html::decode(Form::label('cmbDebit' ,'Debit Account Head  <i class="text-danger">*</i>' ,['class'=>' col-form-label text-left']))   !!}
            </div>
            <div class="col-sm-9">
        ...
        <table id="debtAccVoucher" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            ...
            <tr id="row">
                ...
                <td>
                    {!!  Form::number('txtAmount[]',$data->Credit,['step'=>'any','min'=>'1','id'=>'txtAmount_1','class'=>'form-control total_price text-right' ,'onkeyup'=>'dbtvouchercalculation(1)','required','autocomplete'=>'off']) !!}
