    ...
    @if(count($voucherInfo))
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10 input-group">
                {!!  Form::text('date',\AccountHelper::date_format( $voucherInfo[0]->VDate ),['id'=>'date','class'=>'form-control datepicker','autcomplete'=>'off','required']) !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                {!! Form::textarea('remarks',$voucherInfo[0]->Narrration,['class' => 'form-control', 'size' => '50x2','placeholder'=>'Remark']) !!}
            </div>
        </div>
...
@else
    ...
    <table id="debtAccVoucher" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
        ...
        <tr id="row">
            ...
            <td>
                {!!  Form::number('txtAmount[]',null,['step'=>'any','min'=>'1','id'=>'txtAmount_1','class'=>'form-control total_price text-right' ,'onkeyup'=>'calculationContravoucher(1)','autocomplete'=>'off']) !!}

            </td>
            <td>
                {!!  Form::number('txtAmountcr[]',null,['step'=>'any','min'=>'1','id'=>'txtAmount1_1','class'=>'form-control total_price1 text-right' ,'onkeyup'=>'calculationContravoucher(1)','autocomplete'=>'off']) !!}
