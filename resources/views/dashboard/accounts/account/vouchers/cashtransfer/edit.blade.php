                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="general-label">
                                    {!! Form::model($debitInfo,['route' => ['dashboard.accounts.credit.voucher.update',$debitInfo[0]->VNo], 'files' => true] ) !!}
                                    {!! csrf_field() !!}
                                    @method('PATCH')

                                    @include('dashboard.accounts.account.vouchers.common.cashtransfer-common',['for'=>'edit'])
