        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="penal-title  border-grey border-bottom">
                    <h4 class="p-3 text-dark">Debit Voucher</h4>
                </div>
                <div class="card-body">

                    <div class="general-label">
                        {!! Form::open(['route' => 'dashboard.accounts.debit.voucher.store', 'files' => true, 'id'=>'voucher_form', 'class' => 'solid-validation'] ) !!}
                        {!! csrf_field() !!}

                        @include('dashboard.accounts.account.vouchers.common.debit-common')
