            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="penal-title  border-grey border-bottom">
                        <h4 class="p-3 text-dark">{{ __('accounts.customers.voucher_title') }}</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                    {!! Form::open(['route' => 'add.customer.receive', 'files' => true, 'id'=>'voucher_form', 'class' => 'solid-validation'] ) !!}
                                    {!! csrf_field() !!}
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-3">
                                            {!!  Html::decode(Form::label('customer_id' ,'Customer   <i class="text-danger">*</i>' ,['class'=>'col-form-label']))   !!}
                                        </div>
                                        <div class="col-sm-9">
                                            {!!  Form::select('customer_id',$customer,null,['id'=>'customer_id',
                                                        'class'=>'select2 form-control mb-3 custom-select float-right',
                                                        'placeholder'=>'Choose Customer','required','onchange'=>'getCustomerBalance(this, "amount_balance", "amount_last", null)'])
                                                        !!}
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    @include('dashboard.accounts.common.buttons.buttons-crud', ['save'=>true, 'save_print'=>true, 'form_id'=>'voucher_form', 'cancel'=>true, 'cancel_route'=>'dashboard.accounts.customer.index'])

                                    {!! Form::close() !!}
                            </div>
                            <div class="col-md-2">&nbsp;</div>
                            <div class="col-md-4 text-right">
                                <h4 class="text-dark">{{ __('accounts.general.last_received_amount') }}: <span class="font-weight-bold text-muted" id="amount_last">0.00</span></h4>
