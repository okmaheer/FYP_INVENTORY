                                    ...
                                    <table class="table table-striped mb-3 table-bordered mb-0 table-centered" cellpadding="6" cellspacing="1" width="100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @forelse($report as $key => $report)
                                                                ...
                                                                <tr>
                                                                    <td>{{$key + 1}}</td>
                                                                    <td>{{AccountHelper::date_format($report->purchase_date)}}</td>
                                                                    <td>{{$report->id}}</td>
                                                                    <td>{{$report->supplier->supplier_name}}</td>
                                                                    <td>{{AccountHelper::number_format($report->grand_total_amount)}}</td>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td><b>{{ AccountHelper::number_format($balance) }}</b></td>
                                                            </tr>
                                                        </tfoot>
                                                    </table>
                                </div>
