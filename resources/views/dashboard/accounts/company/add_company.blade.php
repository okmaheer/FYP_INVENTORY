...
@section('page_title', trans('accounts.company.new_company'))
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="panel-title border-grey border-bottom">
                        <h3 class="p-3 text-dark">{{ trans('accounts.company.new_company') }}</h3>
                    </div>
                    <div class="card-body">
                        {!! Form::open([ 'route' => 'dashboard.accounts.companies.store', 'files' => true] ) !!}
                        <div class="row">
                            <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        {!!  Form::file('logo', ['id'=>'logo','class'=>'dropify']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        @include('dashboard.accounts.common.buttons.buttons-crud', ['save' => true, 'cancel' => true, 'cancel_route' => 'dashboard.accounts.companies.index'])
                    </div>
                </div>
            </div>
        </div>
