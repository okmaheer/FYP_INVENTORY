                                ...
                                <div class="card-body">
                                    ...
                                    <h4 class="mt-0 header-title">Add Service</h4>
                                                ...
                                                <div class="general-label mt-4">
                                                    {!!  Form::model($service, ['route' => ['dashboard.accounts.service.update', $service] , 'files' => true ]) !!}
                                                    @csrf
                                                    @method('PUT')
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                {!!  Form::text('service_name',null,['id'=>'service_name','class'=>'form-control ','placeholder'=>'Service Name','required']) !!}
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                {!!  Form::text('charge',null,['id'=>'charge','class'=>'form-control ','placeholder'=>'Charge ','required']) !!}
