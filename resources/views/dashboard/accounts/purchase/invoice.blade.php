...
{{--                                                        <th class="text-center">{{ trans('accounts.general.discount') }}</th>--}}
                                                        <th class="text-center">{{ trans('accounts.general.tax') }}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center">{{ $entry->product->product_name }}</th>
                                                        <td class="text-right">{{ number_format($entry->quantity) }}</td>
                                                        <td class="text-right">{{ number_format($entry->rate, 2) }}</td>
                                                        <td class="text-right">{{ number_format($entry->quantity * $entry->rate, 2) }}</td>
{{--                                                        <td class="text-right">{{ number_format($entry->discount, 2) }}</td>--}}
                                                        <td class="text-right">{{ $entry->tax_p > 0 ? ('(' . $entry->tax_p . '%)') : '' }} {{ number_format($entry->tax_amount, 2) }}</td>
                                                    ...
                                                    <tr class="bg-dark text-white">
                                                        <th colspan="5"  style="background: #2f394e !important; color: #ffffff !important; border: 0!important;" class="border-0"></th>
                                                    ...
                                                    <tr class="bg-dark text-white">
                                                        <th colspan="5"  style="background: #2f394e !important; color: #ffffff !important; border: 0!important;" class="border-0"></th>
                                                        <td  style="background: #2f394e !important; color: #ffffff !important; border: 0!important;" class="border-0 font-14 text-right"><b>Net Total</b></td>
                                                        <td  style="background: #2f394e !important; color: #ffffff !important; border: 0!important;" class="border-0 font-14 text-right "><b>{{ number_format($purchase->net_total_amount, 2) }}</b></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
