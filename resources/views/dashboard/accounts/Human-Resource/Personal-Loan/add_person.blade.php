                            ...
                            <div class="card-body">
                                ...
                                <div class="general-label">
                                   ...
                                   <div class="form-group row">
                                       <div class="col-sm-2">
                                           {!!  Form::label('name' ,{{__('accounts.office.name')}} ,['class'=>'col-form-label text-right'])   !!}
                                   ...
                                   <div class="form-group row">
                                       <div class="col-sm-2">
                                           {!!  Html::decode(Form::label('phone' ,{{__('accounts.office.phone')}}.'<i class="text-danger">*</i>' ,['class'=>' col-form-label']))   !!}
                                   ...
                                   <div class="form-group row">
                                       <div class="col-sm-2">
                                           {!!  Form::label('address' ,{{__('accounts.office.address')}} ,['class'=>'col-form-label text-right'])   !!}
                                       <label for="horizontalInput2" class=" col-form-label">Address</label>
                                       </div>
                                       <div class="col-sm-10">
                                           {!! Form::textarea('address',null,['class' => 'form-control', 'size' => '50x2','placeholder'=>'Address']) !!}
