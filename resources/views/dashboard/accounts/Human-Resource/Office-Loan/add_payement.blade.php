                            ...
                            <div class="card-body">
                                ...
                                <div class="general-label">
                                     ...
                                     <div class="form-group row">
                                         <div class="col-sm-2">
                                             {!!  Html::decode(Form::label('name' ,__('accounts.office.name').'<i class="text-danger">*</i>' ,['class'=>' col-form-label']))   !!}
                                     ...
                                     <div class="form-group row">
                                         <div class="col-sm-2">
                                             {!!  Html::decode(Form::label('amount' ,__('accounts.office.amount').'<i class="text-danger">*</i>' ,['class'=>' col-form-label']))   !!}
                                     ...
                                     <div class="form-group row">
                                         <div class="col-sm-2">
                                             {!!  Html::decode(Form::label('date' ,__('accounts.office.date').'<i class="text-danger">*</i>' ,['class'=>' col-form-label']))   !!}
                                     ...
                                     <div class="form-group row">
                                         <div class="col-sm-2">
                                             {!!  Form::label('detail' ,__('accounts.office.phone') ,['class'=>'col-form-label text-right'])   !!}
