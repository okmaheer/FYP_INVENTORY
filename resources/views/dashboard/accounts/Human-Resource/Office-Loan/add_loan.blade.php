            ...
            <div class="page-content">
                <div class="container-fluid">
                    <div class="row  mb-2">
                        ...
                        <div class="card">
                            <h4 class="p-3 text-success">{{__('accounts.office.add_loan')}}</h4>
                            <div class="card-body">
                                ...
                                <div class="general-label">
                                    ...
                                    {!! csrf_field() !!}
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                {!!  Html::decode(Form::label('name' ,__('accounts.office.name').'<i class="text-danger">*</i>' ,['class'=>' col-form-label','required']))   !!}
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                {!!  Form::label('phone' ,__('accounts.office.phone') ,['class'=>'col-form-label text-right'])   !!}
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                {!!  Html::decode(Form::label('amount' , __('accounts.office.amount').'<i class="text-danger">*</i>' ,['class'=>' col-form-label','required']))   !!}
                                            {{-- <label for="horizontalInput1" class=" col-form-label">Amount<i class="text-danger"> *</i></label> --}}
                                            </div>
                                            <div class="col-sm-10">
                                                {!!  Form::text('amount',null,['id'=>'amount','class'=>'form-control ','placeholder'=>'0.00']) !!}
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                {!!  Html::decode(Form::label('payment_type' ,__('accounts.office.p_type').' <i class="text-danger">*</i>' ,['class'=>' col-form-label']))   !!}

                                            </div>
                                            <div class="col-sm-10">
                                                {!!  Form::select('payeme_type',AccountHelper::manualStatus(),null,['id'=>'payeme_type',
                                                'class'=>'select2 form-control mb-3 custom-select float-right',
                                                'placeholder'=>'Cash Payement'])
                                        !!}
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                {!!  Html::decode(Form::label('date' ,__('accounts.office.date').'<i class="text-danger">*</i>' ,['class'=>' col-form-label','required']))   !!}

                                            </div>
                                            <div class="col-sm-10">
                                                {!!  Form::date('date',null,['id'=>'date','class'=>'form-control ','placeholder'=>'Amount']) !!}
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                                {!!  Form::label('detail' ,__('accounts.office.detail'),['class'=>'col-form-label text-right'])   !!}
