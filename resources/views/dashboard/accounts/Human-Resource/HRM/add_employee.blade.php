            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="penal-title border-grey border-bottom">
                        <h4 class="p-3 text-dark">{{__('accounts.hrm.employee_add')}}</h4>
                    </div>
                    <div class="card-body">

                        <div class="general-label">
                            {!! Form::open(['route' => 'dashboard.accounts.employee.store', 'files' => true, 'id' => 'employee_form', 'class' => 'solid-validation'] ) !!}
                            <div class="row">
                                <div class="col-lg-6">
                            ...
                            @include('dashboard.accounts.common.buttons.buttons-crud',
                                ['save' => true, 'save_new' => true, 'form_id' => 'employee_form', 'reset' => true,
                                'cancel' => true, 'cancel_route' => 'dashboard.accounts.employee.index'])
                            {!! Form::close() !!}
                        </div>
                    </div>
                    <!--end card-body-->
