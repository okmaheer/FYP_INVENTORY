                        ...
                        @include('includes.messages')  <!--ALert Message--->
                            <div class="panel-title ">
                                <div class="row border-grey border-bottom">
                                    <div class="col-lg-12">
                                        <h3 class="p-3 text-dark text-center">{{__('accounts.income.add_head')}}</h3>
                                    </div>
                                </div>
                            </div>

                            <div class="card-body">
                                {!! Form::open(['route' => 'dashboard.accounts.incomehead.store', 'files' => true, 'id' => 'income_head_form', 'class' => 'solid-validation'] ) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-5">
                                        {!!  Form::select('parent_id', $parentHeads,null,['id'=>'parent_id',
                                            ...
                                            'placeholder'=>'Select Parent Income Head'])
                                        !!}
                                    </div>
                                </div>
                                @include('dashboard.accounts.common.buttons.buttons-crud', ['save' => true, 'save_new' => true, 'form_id' => 'income_head_form', 'cancel' => true, 'cancel_route' => 'dashboard.accounts.incomehead.index'])
                                {!! Form::close() !!}
                            </div>
                            <!--end card-body-->
                        </div>
