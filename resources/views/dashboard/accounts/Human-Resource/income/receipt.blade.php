            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="penal-title  border-grey border-bottom">
                        <h4 class="p-3 text-success">Income Payment</h4>
                    </div>
                                                        ...
                                                        <td>
                                                            ...
                                                            <table border="0" width="100%">
                                                                ...
                                                                <tr class="text-center">
                                                                    <td>
                                                                        <h5>
                                                                            {{$income->income_HeadName->income_head_name}}
                                                                        </h5>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="text-left">Voucher Number
                                                                        : {{ $income->voucher_no }}</td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="text-left">Payment Type
                                                                        : {{ \AccountHelper::paymentTypes($income->payment_type) }}</td>
                                                                </tr>
                                                                <tr>
