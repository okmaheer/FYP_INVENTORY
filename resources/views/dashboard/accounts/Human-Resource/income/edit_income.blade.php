...
@section('body')
            <div class="page-content">
                <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-3 mt-4"><h4 class="ml-4">Add Income </h4></div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="general-label">
                                    {!! Form::model($income , ['route' => ['dashboard.accounts.income.update', $income->id], 'files' => true, 'class' => 'solid-validation'] ) !!}
                                    {!! csrf_field() !!}
                                    @method('PATCH')
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-2">
                                            {!!  Html::decode(Form::label('income_type' ,'Income Type  <i class="text-danger">*</i>' ,['class'=>'col-form-label']))   !!}

                                            </div>
                                            <div class="col-sm-10">
                                                {!!  Form::select('income_type',AccountHelper::manualStatus(),null,['id'=>'income_type',
