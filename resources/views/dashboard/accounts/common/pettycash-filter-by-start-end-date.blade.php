    ...
    <div class="row col-12">
        <div class="col-md-4">
            <div class="form-group">
                {!!  Form::label('pettycash_id' ,'PettyCash Account' ,['class'=>'col-form-label text-right'])   !!}
                {!!  Form::select('pettycash_id',$pettycash,request()->has('pettycash_id')?request()->get('pettycash_id'):null,['id'=>'pettycash_id',
