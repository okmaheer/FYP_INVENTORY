    ...
    <div class="row col-12">
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::text('start_date', request()->has('start_date') ? request()->get('start_date') : \AccountHelper::date_format(\Carbon\Carbon::today()), ['id' => 'start_date', 'class' => 'form-control datepicker', 'autocomplete' => 'off']) !!}
        ...
        <div class="col-lg-4">
            <div class="form-group">
                ...
                <div class="input-group">
                    {!! Form::text('end_date', request()->has('end_date') ? request()->get('end_date') : \AccountHelper::date_format(\Carbon\Carbon::today()), ['id' => 'end_date', 'class' => 'form-control datepicker', 'autocomplete' => 'off']) !!}
                    <div class="input-group-append">
                        <span class="input-group-text"><i class="fas fa-calendar-alt"></i></span>
                    </div>
                </div>
