    ...
    <div class="row col-12">
        <div class="col-md-4">
            <div class="form-group">
                {!!  Form::label('supplier_id' ,'Supplier' ,['class'=>'col-form-label text-right'])   !!}
                {!!  Form::select('supplier_id',$supplier,request()->has('supplier_id')?request()->get('supplier_id'):null,['id'=>'supplier_id',
