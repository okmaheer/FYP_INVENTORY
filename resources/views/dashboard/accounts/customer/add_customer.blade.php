                    ...
                    <div class="card">
                        <div class="panel-title ">
                            <div class="row border-grey border-bottom">
                                <div class="col-lg-12">
                                    <h3 class="p-3 text-dark text-center">{{ __('accounts.customers.add') }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            {!! Form::open(['route' => 'dashboard.accounts.customer.store','class'=>'needs-validation', 'files' => true, 'class' => 'solid-validation'] ) !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                {!!  Form::text('customer_name',null,['id'=>'customer_name,validationCustomUsername','class'=>'form-control ','placeholder'=>__('accounts.customers.name'),'required']) !!}
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::textarea('customer_address',null,['class' => 'form-control', 'size' => '20x2','placeholder'=>'Address1','required']) !!}
