...
@section('body')
    <div class="page-content">
        <div class="container-fluid">
            {!! Form::model($model, ['route' => 'dashboard.marquee.booking.store', 'method' => 'POST', 'files' => true, 'id' => 'booking_form', 'class' => 'solid-validation'] ) !!}
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include('dashboard.marquee.bookings.components.general',['for'=>'edit','from'=>'quot'])
                        </div>
                    </div>
                    <div class="card">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            @include('dashboard.marquee.bookings.components.totals', ['for'=>'edit', 'from' => 'quot'])
                        </div>
                    </div>
                </div>
            </div>
