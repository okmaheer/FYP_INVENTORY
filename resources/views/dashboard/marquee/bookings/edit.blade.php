...
@section('body')
    <div class="page-content">
        <div class="container-fluid">
            {!! Form::model($model, ['route' => ['dashboard.marquee.booking.update', $model->id], 'method' => 'PUT', 'files' => true, 'id' => 'booking_form', 'class' => 'solid-validation'] ) !!}
            {!! csrf_field() !!}
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::select('status',MarqueeHelper::getBookingStatuses(),null,['class'=>'form-control select2','placeholder'=>'Change Status']) !!}
                        </div>
                    </div>
                    <div class="card">
                        ...
                        <div class="card-body">
                            @include('dashboard.marquee.bookings.components.general',['for'=>'edit'])
                        </div>
                    </div>
                    <div class="card">
                    ...
                    {{--<div class="card">
                        <div class="card-header bg-white bg-transparent py-0">
                            <h4 class="mt-1 ml-2 header-title">
                                {!!  Html::decode(Form::label('stage_decorations' ,'SELECT STAGE/DECORATION ' ,['class'=>'col-form-label text-right']))   !!}
                            </h4>
                        </div>
                        <div class="card-body">
                            @include('dashboard.marquee.bookings.components.stage-decorations',['for'=>'edit'])
                        </div>
                    </div>--}}
                    {{--<div class="card">
                        <div class="card-header bg-white bg-transparent py-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            @include('dashboard.marquee.bookings.components.totals', ['for'=>'edit'])
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            @include('dashboard.accounts.common.buttons.buttons-crud', ['update' => true, 'update_print' => true, 'form_id' => 'booking_form',
                                    'cancel' => true, 'cancel_route' => 'dashboard.marquee.booking.index'])
                        </div>
                    </div>
                </div>
            </div>
