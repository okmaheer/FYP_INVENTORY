    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-4">
                        {!!  Html::decode(Form::label('modal_customer_cnic' ,__('accounts.general.cnic') . '<i class="text-danger">*</i>' ,['class'=>'col-form-label text-right']))   !!}
                    </div>
                    <div class="col-sm-8">
                        {!!  Form::text('cnic',null,['id'=>'modal_customer_cnic','class'=>'form-control ','placeholder'=>'Customer CNIC', 'required']) !!}
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-4">
