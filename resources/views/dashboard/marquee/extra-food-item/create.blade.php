                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    {!! Form::open(['route' => ['dashboard.marquee.extra_food_items.store'], 'method' => 'POST', 'id' => 'addon_form', 'files' => true, 'class' => 'solid-validation'] ) !!}
                                    ...
                                    @include('dashboard.accounts.common.buttons.buttons-crud', ['save' => true, 'save_new' => true, 'form_id' => 'addon_form', 'cancel' => true, 'cancel_route' => 'dashboard.marquee.extra_food_items.index'])
                                    {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
