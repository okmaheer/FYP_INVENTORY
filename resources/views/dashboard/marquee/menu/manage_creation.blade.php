                                                ...
                                                <tbody id="test-body">
                                                    <tr id="row">
                                                        <td>
                                                            ...
                                                            {{-- <select name="status" id="select_val" class=" form-control mb-3 custom-select float-right">
                                                                <option id="slct" value="0">Select One</option>
                                                                <option id="out_s" value="1">Yes</option>
                                                                <option id="in_h" value="2">No</option>
                                                            </select> --}}
                                                        </td>
                                                        <td>
                                                            {!!  Form::select('status', AccountHelper::manualStatus(),null,['id'=>'status',
