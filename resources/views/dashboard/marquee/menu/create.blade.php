...
@section('content')
    ...
    @section('body')
        <div class="page-content">
            ...
            {!! Form::open(['route' => 'dashboard.marquee.menu.store', 'files' => true, 'id' => 'menu_form', 'class' => 'solid-validation'] ) !!}
                <div class="card">
                @include('includes.messages')  <!--ALert Message--->
                    ...
                    <div class="card-body justify-content-center" style="width:96%;">
                        <div class="row">
                            <div class="col-lg-12">
                                @include('dashboard.marquee.menu.components.general')
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="card-body justify-content-center" style="width:96%;">
                        <div class="row">
                            <div class="col-lg-12">
                                @include('dashboard.marquee.menu.components.items')
                            </div>
                        </div>
                    </div>
                </div>
...
@include('dashboard.marquee.menu.common-scripts')
