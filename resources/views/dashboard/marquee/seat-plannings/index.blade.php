                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left"
                                                            ...
                                                            <form
                                                                action="{{ route('dashboard.marquee.seat-plannings.destroy',$d->id) }}"
                                                                method="POST">
                                                                {!! link_to_route('dashboard.marquee.seat-plannings.edit', "Edit", $d->id, ['class' => 'dropdown-item']) !!}
                                                                @csrf
                                                                @method('DELETE')
                ...
                "buttons": [
                    ...
                    , {
                        ...
                        action: function (dt, node, config) {
                            window.location = '{{ route('dashboard.marquee.seat-plannings.create') }}';
                        }
                    }
                ],
            });
