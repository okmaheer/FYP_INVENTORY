    ...
    @section('body')
            ...
            <div class="page-content">
                <div class="container-fluid">
                    <div class="card">
                        @include('dashboard.marquee.filters.bookingquotation_no_filter',['route'=>'dashboard.marquee.quotation.booking.index'])
                    </div>
                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left"
                                                            ...
                                                            <a href="{{ route('dashboard.marquee.quotation.booking.edit', $d->id) }}" class="dropdown-item"><i class="fas fa-pencil-alt"></i> Edit</a>
                                                            <a href="javascript:void(0);" onclick="DeleteEntry({{$d->id}});" class="dropdown-item"><i class="fas fa-trash"></i> Delete Record</a>
                                                            <div class="dropdown-divider"></div>
                                                            <a href="{{route('view.quotation.booking',$d->id)}}" class="dropdown-item" target="_blank"><i class="fas fa-money-bill-alt"></i> View Quotation Print</a>
                                                            <a href="{{route('marquee.booking.add-to-booking',['id'=>$d->id])}}" class="dropdown-item" target="_blank"><i class="fas fa-receipt"></i> Add to Booking</a>
                                                            <form action="{{ route('dashboard.marquee.quotation.booking.destroy',$d->id) }}" method="POST" id="deleteForm{{$d->id}}" style="display: none">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                        </div>
...
@endsection
@section('innerScript')
    @include('includes.datatable-init', ['table' => 'datatable', 'create' => 'dashboard.marquee.quotation.booking.create'])
    <script>
