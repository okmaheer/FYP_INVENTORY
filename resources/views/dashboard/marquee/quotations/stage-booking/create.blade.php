...
@section('content')
    ...
    @section('body')
        <div class="page-content">
            <div class="container-fluid">
                {!! Form::open(['route' => 'dashboard.marquee.quotation.stage.store', 'files' => true, 'id' => 'booking_form', 'class' => 'solid-validation'] ) !!}
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @include('dashboard.marquee.quotations.common-components.general-stage')
                            </div>
                        </div>
    ...
    @endsection
@endsection
@include('dashboard.marquee.quotations.stage-booking.common-script')
