        ...
        @if(count($model->foodItems))
            @foreach($model->foodItems as $foodItem)
                <tr>
                    ...
                    <td>
                        {!!  Form::text('foodItems[total][]',$foodItem->pivot->total,['min'=>'0','id'=>'oodItems[total][]','class'=>'form-control  current_total','placeholder'=>'','readonly','oninput'=>"this.value = Math.abs(this.value)"]) !!}
                    </td>
        ...
        @else
            <tr>
                ...
                <td>
                    ...
                    {!!  Form::text('foodItems[total][]',null,['min'=>'0','id'=>'oodItems[total][]','class'=>'form-control  current_total','placeholder'=>'','readonly','oninput'=>"this.value = Math.abs(this.value)"]) !!}
                </td>
                <td class="text-center">
                    <a href="javascript:void(0);"
                       onclick="removeClonedRow(this);"
