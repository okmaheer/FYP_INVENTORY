                ...
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    {!!  Html::decode(Form::label('sec_contact_no' ,'Request Data' ,['class'=>'col-form-label text-right']))   !!}
                                    <div class="input-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    {!!  Html::decode(Form::label('national_id_card' ,'Delivery Date' ,['class'=>'col-form-label text-right ml-1']))   !!}
                                    <div class="input-group ">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @include('dashboard.marquee.demand.comp.receive_demand_item')
