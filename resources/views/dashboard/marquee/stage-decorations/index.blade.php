                                                ...
                                                <td class="text-center">
                                                    <div class="dropdown d-inline-block">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left"
                                                            ...
                                                            {!! link_to_route('dashboard.marquee.stage-decorations.edit', "Edit", $d->id, ['class' => 'dropdown-item']) !!}
                                                            <button type="button" class="dropdown-item"
                                                                    onclick="DeleteEntry({{ $d->id }});">
                                                                Delete
                                                            </button>
                                                            <form action="{{ route('dashboard.marquee.stage-decorations.destroy',$d->id) }}" method="POST" id="deleteForm{{ $d->id }}">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                        </div>
...
@endsection
@section('innerScript')
    @include('includes.datatable-init', ['table' => 'datatable', 'create' => 'dashboard.marquee.stage-decorations.create'])
@endsection
