@if(isset($for))
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="input-group">
                {!! Form::number('misc_discount_total',null,['id'=>'misc_discount_total','class'=>'form-control text-right','placeholder'=>'0.00','onkeyup'=>'applyCalculations();','onchange'=>"applyCalculations();",'autocomplete'=>'off','tabindex' => 39]) !!}
            </div>
        </div>
        <div class="col-md-3">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="input-group">
                {!! Form::number('total_paid_amount',isset($from) ? '' : null,['id'=>'total_paid_amount','class'=>'form-control text-right','placeholder'=>'0.00','onkeyup'=>'applyCalculations();','onchange'=>"applyCalculations();",'autocomplete'=>'off','tabindex' => 42]) !!}
            </div>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                {!! Form::text('total_dues_amount',null,['id'=>'total_dues_amount','class'=>'form-control text-right','placeholder'=>'0.00','readonly','tabindex' => 44]) !!}
            </div>
        </div>
    </div>
@else
    ...
    <div class="row">
        <div class="col-md-4">
            {!!  Html::decode(Form::label('total_paid_amount' ,'Paid Amount' ,['class'=>'col-form-label text-right ml-1']))   !!}
            <div class="input-group">
                {!! Form::number('total_paid_amount',null,['id'=>'total_paid_amount','class'=>'form-control text-right','placeholder'=>'0.00','onkeyup'=>'applyCalculations();','onchange'=>"applyCalculations();",'autocomplete'=>'off','tabindex' => 42]) !!}
            </div>
        </div>
        <div class="col-md-4">
            {!!  Html::decode(Form::label('paid_percentage' ,'Paid Percentage' ,['class'=>'col-form-label text-right ml-1']))   !!}
