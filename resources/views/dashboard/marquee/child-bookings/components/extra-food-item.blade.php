        ...
        @if(count($model->extraFoodItems))
            ...
            {{ $model->extraFoodItems }}
                <tr>
                   ...
                   <td>
                       {!!  Form::number('extraFoodItems[quantity][]',$foodItem->pivot->quantity,['min'=>'0','step'=>"any",'id'=>'extraFoodItems[quantity][]','class'=>'form-control  current_quantity','placeholder'=>'0','onkeyup'=>'applyQuantity(this);','onchange'=>"'applyQuantity(this);"]) !!}
                   </td>
                    <td>
                        {!!  Form::number('extraFoodItems[price][]',$foodItem->pivot->price,['min'=>'0','id'=>'extraFoodItems[price][]','class'=>'form-control  current_price_only','placeholder'=>'0.00','onkeyup'=>'applyPriceOnly(this);','onchange'=>"applyPriceOnly(this);"]) !!}
                    </td>
                    <td>
        ...
        @else
            <tr>
               ...
               <td>
                ...
                <td>
                    {!!  Form::number('extraFoodItems[price][]',null,['min'=>'0','id'=>'extraFoodItems[price][]','class'=>'form-control  current_price_only','placeholder'=>'0.00','onkeyup'=>'applyPriceOnly(this);','onchange'=>"applyPriceOnly(this);"]) !!}
                </td>
                 <td>
