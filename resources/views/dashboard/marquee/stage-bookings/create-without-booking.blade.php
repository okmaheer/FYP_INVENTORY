{!! Form::open(['route' => 'dashboard.marquee.stage.booking.store', 'files' => true, 'id' => 'wob_booking_form', 'class' => 'solid-validation'] ) !!}
{!! csrf_field() !!}
...
@include('dashboard.marquee.stage-bookings.components.totalswob')
<div class="row">
    <div class="col-12 text-right">
        <div class="card">
            <div class="card-body">
                @include('dashboard.accounts.common.buttons.buttons-crud', ['save' => true, 'save_print' => true, 'form_id' => 'wob_booking_form',
