...
@section('body')
    <div class="page-content">
        <div class="container-fluid">
            {!! Form::model( $model,[ 'route' => ['dashboard.marquee.hr_demand.update',$model->id],'files' => true] ) !!}
            {!! csrf_field() !!}
            @method('PATCH')
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="row mb-5">
                                <div class="panel-title col-12  border-bottom">
                                    ...
                                    @include('dashboard.marquee.hr-resources-demand.comp.hr',['for'=>'edit'])
                            </div>
                    </div>
                </div>
                    <!--end card-->
                        ...
                        <div class="card-body">
                            <div class="row mb-5">
                                <div class="panel-title col-12  border-bottom">
                                    ...
                                    @include('dashboard.marquee.hr-resources-demand.comp.resources',['for'=>'edit'])
