                ...
                <div class="card">
                    ...
                    <div class="panel-title ">
                        <div class="row border-grey border-bottom">
                            <div class="col-lg-12">
                                <h4 class="p-3 text-dark">{{ __('accounts.supplier.add') }}</h4>
                            </div>

                        </div>
                    </div>
                    <div class="card-body">
                            {!! Form::open(['route' => 'dashboard.accounts.supplier.store', 'files' => true, 'class' => 'solid-validation', 'id' => 'supplier_form'] ) !!}
                            {!! csrf_field() !!}
                            <div class="row">
