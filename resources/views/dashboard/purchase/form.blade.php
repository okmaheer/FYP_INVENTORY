...
@section('body')
        ...
        <!-- Plugins js -->
        <script src="{{ url('dashboard/plugins/nestable/script.js') }}"></script>
        <script src="{{ url('dashboard/plugins/moment/moment.js') }}"></script>
        <script src="{{ url('dashboard/plugins/timepicker/bootstrap-material-datetimepicker.js') }}"></script>
        <script src="{{ url('dashboard/plugins/clockpicker/jquery-clockpicker.min.js') }}"></script>
        <script src="{{ url('dashboard/plugins/colorpicker/jquery-asColorPicker.min.js') }}"></script>
       ...
       <script src="{{ url('dashboard/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js') }}"></script>
        <script src="{{ url('dashboard/plugins/bootstrap-touchspin/js/jquery.bootstrap-touchspin.min.js') }}"></script>
        <script src="{{ url('dashboard/pages/jquery.forms-advanced.js') }}"></script>
