                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="panel-title  border-grey border-bottom">
                            <h4 class="p-3 text-dark">{{ trans('accounts.products.add_product') }}</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::file('image', ['id' => 'image','class' => 'form-control dropify', 'data-height' => '105', 'data-allowed-file-extensions' => 'jpg jpeg bmp gif', 'data-max-file-size' => '1M']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
