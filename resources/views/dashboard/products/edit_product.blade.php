                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                {!! Form::file('image', ['id' => 'image','class' => 'form-control dropify', 'data-default-file' => asset($product->image), 'data-height' => '105', 'data-allowed-file-extensions' => 'jpg jpeg bmp gif', 'data-max-file-size' => '1M']) !!}
                                            </div>
                                        </div>
